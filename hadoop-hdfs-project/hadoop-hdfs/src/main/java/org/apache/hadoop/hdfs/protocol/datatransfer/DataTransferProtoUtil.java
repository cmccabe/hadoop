  ...
  static BaseHeaderProto buildBaseHeader(ExtendedBlock blk,
    ...
    if (spanId.isValid()) {
      builder.setTraceInfo(DataTransferTraceInfoProto.newBuilder()
          .setParentIdHigh(spanId.getHigh())
          .setParentIdLow(spanId.getLow()));
    }
    return builder.build();
  }

  public static SpanId fromProto(DataTransferTraceInfoProto proto) {
    if ((proto != null) && proto.hasParentIdHigh() &&
          proto.hasParentIdLow()) {
      return new SpanId(proto.getParentIdHigh(), proto.getParentIdLow());
    }
    return null;
  }
